...
export function PricingTabs() {
    const tabs = [
        {
            ...
            content: (
                <div
                    className="w-full overflow-hidden relative min-h-[60vh] rounded-2xl p-10 text-xl md:text-4xl font-bold text-white bg-[#9D00FF] flex flex-col items-center gap-3">
    ...
    return (
        <div
            className="min-h-[22rem] md:min-h-[42rem] [perspective:1000px] relative b flex flex-col max-w-[80vw] mx-auto w-full items-start justify-start my-[13vh] z-20">
            <Tabs tabs={tabs} />
        </div>
    );
}
